...
and t.name In (N'MobileDevices', N'MobileSessions', N'NPErrorLog', N'OffenderInformationMerges', N'PreaReporting', N'ReportsOld', N'Screens', N'SecEnt', N'StoredReports', N'UserLocations', N'UserNameChanges')
