...
RESTORE DATABASE [QRM_Source] FROM  DISK = N'\\pfs02\SQLtempBackup\Prod\QRM_Source.bak' WITH  FILE = 1,  MOVE N'QRM_Log' TO N'F:\MSSQL10_50.MSSQLSERVER\MSSQL\Logs\QRM_Source.ldf',  NOUNLOAD,  REPLACE,  STATS = 10
GO
