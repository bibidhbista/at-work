...
RESTORE DATABASE [SalesLogix] FROM  DISK = N'\\pfs02\SQLtempBackup\PROD\SalesLogix.bak' WITH  FILE = 3,  MOVE N'SalesLogix_Log' TO N'F:\MSSQL10_50.MSSQLSERVER\MSSQL\Log\SalesLogix.ldf',  NOUNLOAD,  REPLACE,  STATS = 5
GO
