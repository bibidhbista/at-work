...
$url = "https://www.linkedin.com/jobs/search/?f_LF=f_AL&keywords=developer&location=Des%20Moines%2C%20Iowa%20Area&locationId=us%3A212";
#$emoji = ":D"
#initialize browser
...
($ie.document.getelementsbyclassname("jobs-s-apply__button")).click()#value =  $caseNum;  #getElementsByName("appReceiptNum") 
