...
POWERSHELL COMMAND:
./Sln_Deploy.ps1 -environment "Prod" -githubRepoPath "file:///c:/users/bbista/desktop/svn/" -solutionname "ADV/adventureworks sample reports sql2012.sln"


PARAMS:

ENVIRONMENT: DEV/TEST/PROD/UAT : SELECT PROD FOR DEPLOYS OR AS MENTIONED IN THE CONFIGURATION FILE OF THE SOLUTION
githubRepoPath: PATH TO SVN REPOSITORY (NOTE: PATH TO SUB-DIRECTORY INSIDE THE REPO WON'T WORK. EX: "file:///c:/users/bbista/desktop/svn/ADV" ABOVE WON'T WORK)
...
[CmdletBinding()]
        ...
        param (
                   ...
                   [ValidateSet('Dev','Test','UAT','Prod')] 
                        [string] $Environment,
                    # Github Path to the solution/report
                    [Parameter(Mandatory=$True)]
                    [ValidateNotNull()]
    ...
    $githubRepoPath ="https://github.com/bbdhbista/ssrspowershell/trunk/AdventureWorks Sample Reports/ADV"
    ...
    # for solution file
        ...
        svn co $githubRepoPath $svnLocalPath
