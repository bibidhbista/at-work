...
'TFHLBDMSSIS02','UFHLBDMSSIS02','PFHLBDMSSIS02','QFHLBDMSQL14','SQLTEST2016','SQLTEST2016-1','SQLTEST2016-2','SQLTEST2016-3','SQLTEST2016-4')]
   ...
   [Parameter(Mandatory=$True, HelpMessage='ENTER A VALID SQL SERVER ENVIRONMENT FOR CONNECTION - NO ALIASES')]
   [ValidateNotNullorEmpty()]  
   [ValidateSet('DFHLBDMSQL12','TFHLBDMSQL12','UFHLBDMSQL12','*REPLACED*SQL12','DFHLBDMSQL09','TFHLBDMSQL09','*REPLACED*SQL09','TSHAREPSQL02','PSHAREPSQL02','DFHLBDMSQL10','TFHLBDMSQL05', 
'TFHLBDMSQL10','TQRMSQL11','TVIEWSQL01','HVMSQL04','PADMINSQL01','PADMINSQL02','PADMINSQL03','PDSXAPP02','*REPLACED*SQL05','*REPLACED*SQL10','PFOGSQL01','PQRMSQL11','PVMSQL04',
'*REPLACED*SSIS01','DFHLBDMSQL14','*REPLACED*SQL14','*REPLACED*SQL13','DFHLBDMSSIS01','UFHLBDMSQL07','DFHLBDMSQL08','UFHLBDMSQL10','*REPLACED*SSRS04','DFHLBDMSQL13','DFHLBDMSQL07','*REPLACED*SQL15','TFHLBDMSQL13',
'SQLTEST2016','*REPLACED*SQL07','TFHLBDMSSIS01','TFHLBDMSQL07','TFHLBDMSSRS04','DFHLBDMSSRS04','UFHLBDMSQL14','TFHLBDMSQL14','UFHLBDMSSRS04','UFHLBDMSSIS01','*REPLACED*SQL08','DFHLBDMSSIS02', 'DFHLBDMSQL15','TFHLBDMSQL15',
'TFHLBDMSSIS02','UFHLBDMSSIS02','*REPLACED*SSIS02','QFHLBDMSQL14','SQLTEST2016','SQLTEST2016-1','SQLTEST2016-2','SQLTEST2016-3','SQLTEST2016-4')]
...
###################### Doesn't neccessarily always exist ################################### ???????????????
############################################################################################
