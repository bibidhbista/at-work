...
EXEC sys.sp_addlinkedserver @server ='PDMSQL12' 
SELECT * FROM [PDMSQL12].[ETL_Maintenance].[DBO].[PROCESS_SETTINGS]
...
AS
RETURN(
	SELECT CURR_BUSINESS_DATE FROM [PDMSQL12].[ETL_Maintenance].[DBO].[PROCESS_BUSINESS_DATES] 
	)
