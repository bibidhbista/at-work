...
where 
 SUBSTRING( keys , LEN(keys) -  CHARINDEX(',',REVERSE(keys)) + 2  , LEN(Keys)  ) ='LocationCd' and
    NOT o.name in (N'ChildSupport_H', N'CourtFilingFees_H', N'dmGLTransactionType', N'DOCSanctions_H', N'IDCardTransaction', N'InmatePhoneNumberReview', N'OffenderCommissaryInformation', N'OmailCredits', N'PhoneCreditTransactions', N'PrimaryAccount_H', N'Restitution_H', N'Sender')
