 [CmdletBinding()]
    ...
    (
       ...
       #$ServiceAcc= Invoke-SQLCmd $query -ServerInstance "sqltest2016" -Database 'test_patching'
       ...
       foreach($sAcc in $serviceAccounts){
        ...
        Echo "Succesfully logged the status of service accounts on $computerName to the service accounts table in test_patching db (sqltest2016)."
